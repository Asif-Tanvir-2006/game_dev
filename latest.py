    ...
    def update_movables(self, obj):
        ...
        if not self.check_collision_x(obj):
            ...
            # Movable object collides vertically
                ...
                return 0  # Ready for conversion to immovable
    ...
    def update(self, obj, player_obj):
        ...
        if not self.check_collision_x(obj):
            ...
            # Object is colliding vertically
                ...
                if obj.hitbox.centerx < self.hitbox.centerx and player_obj.hitbox.centerx < self.hitbox.centerx:
                    print("aaaaaa")
                    self.movingLeft = 0
                ...
                elif obj.hitbox.centerx > self.hitbox.centerx and player_obj.hitbox.centerx > self.hitbox.centerx:
                    print("dddddddd")
                    self.movingLeft = 1
...
class wrapper_objects:
    def __init__(self):
        self.movable_objects_list = [
            movable_objects(200, 0, "./assets/image3.png", 90, 150),
            movable_objects(300, 0, "./assets/image3.png", 90, 300),
            movable_objects(400, 0, "./assets/image3.png", 90, 450),
            movable_objects(600, 0, "./assets/image3.png", 90, 60),
        ]
